 ...
 */
Pluf::loadFunction('Verifier_Shortcuts_GetEngineOr404');

class Verifier_Backend extends Pluf_Model
{
     ...
     *
     * تمام داده‌هایی که با کلید meta ذخیره شده را بازیابی می‌کند.
     */
    function restore()
    {
    ...
    {
        return Verifier_Shortcuts_GetEngineOr404($this->engine);
    }
}