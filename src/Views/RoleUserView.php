 ...
 *        
 */
class RoleUserViews extends \Pluf\Views
{
     ...
     * @param array $match
     */
    public static function add(Request $request, $match)
    {
    ...
    public static function get($request, $match)
    {
        ...
        if ($users->count() == 0) {
            throw new DoesNotExistException('User has not such role');
        }
        return $users[0];
    }
